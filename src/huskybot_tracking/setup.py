...
package_name = 'huskybot_tracking'  # Nama package, harus sama dengan folder utama dan package.xml
...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/tracking.launch.py']),  # Install launch file ke share/package/launch (wajib agar bisa ros2 launch)
