...
class Camera_subscriber(Node):  # [WAJIB] Definisi class node subscriber kamera (OOP, reusable)
    def __init__(self):  # [WAJIB] Konstruktor class
        ...
        try:
            # ===================== PARAMETERISASI NODE =====================
            self.declare_parameter('model_path', os.path.expanduser('~/jezzy/huskybot/src/huskybot_recognition/huskybot_recognition/scripts/yolo12n.engine'))  # [WAJIB] Path default model YOLOv12 (TensorRT .engine)
