...
class PanoramaDetection(Node):  # [WAJIB] Definisi class node deteksi panorama (OOP, reusable)
    def __init__(self):  # [WAJIB] Konstruktor class
        ...
        # ===================== PARAMETERISASI NODE =====================
        self.declare_parameter('model_path', os.path.expanduser('~/jezzy/huskybot/src/huskybot_recognition/huskybot_recognition/scripts/yolo12n.pt'))  # [WAJIB] Path default model YOLOv12
