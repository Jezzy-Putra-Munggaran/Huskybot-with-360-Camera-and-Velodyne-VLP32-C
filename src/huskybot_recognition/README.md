...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('model_path', default_value='/mnt/nova_ssd/huskybot/src/huskybot_recognition/scripts/yolo12n.engine'),  # Default TensorRT .engine
...
- File model YOLOv12 (`yolo12n.engine`, `yolo12n.pt`, `yolo12n.onnx`) ada di `scripts/`. <!-- File model YOLOv12 wajib ada di scripts/. -->
