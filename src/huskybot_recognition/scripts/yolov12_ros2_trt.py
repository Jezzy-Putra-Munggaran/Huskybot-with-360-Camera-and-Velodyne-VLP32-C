...
class CameraSubscriberTRT(Node):  # Node deteksi YOLOv12 TensorRT, FULL OOP
    def __init__(self):
        ...
        try:
            # ===================== PARAMETERISASI NODE =====================
            self.declare_parameter('model_path', os.path.expanduser('~/jezzy/huskybot/src/huskybot_recognition/scripts/yolo12n.engine'))  # Path default model YOLOv12 TensorRT
