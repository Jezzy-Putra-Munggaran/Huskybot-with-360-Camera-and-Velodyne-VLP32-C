...
class CameraSubscriberONNX(Node):  # Node deteksi YOLOv12 ONNX, FULL OOP
    def __init__(self):
        ...
        try:
            # ===================== PARAMETERISASI NODE =====================
            self.declare_parameter('model_path', os.path.expanduser('/mnt/nova_ssd/huskybot/src/huskybot_recognition/scripts/yolo12n.onnx'))  # Path default model YOLOv12 ONNX
