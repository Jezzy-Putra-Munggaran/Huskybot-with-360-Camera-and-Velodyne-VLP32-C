#!/usr/bin/env python3
"""
Master launch file untuk 360° Object Segmentation Pipeline
Pipeline: 6 Cameras -> YOLOv11 Segmentation -> LiDAR Fusion -> Visualization

Usage:
ros2 launch huskybot_perception segmentation_360_pipeline.launch.py
