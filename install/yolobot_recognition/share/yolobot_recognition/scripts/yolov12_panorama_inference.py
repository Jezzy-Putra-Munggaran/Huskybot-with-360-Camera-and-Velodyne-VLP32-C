...
class PanoramaDetection(Node):
    def __init__(self):
        ...
        self.pub = self.create_publisher(Yolov12Inference, '/panorama/yolov12_inference', 1)
    ...
    def callback(self, msg):
        ...
        yolov12_inference.header = msg.header
        yolov12_inference.camera_name = "panorama"
        for r in results:
            for box in r.boxes:
        ...
        self.pub.publish(yolov12_inference)
