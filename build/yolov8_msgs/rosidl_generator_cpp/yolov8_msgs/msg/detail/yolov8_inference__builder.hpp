...
class Init_Yolov8Inference_camera_name
{
public:
  explicit Init_Yolov8Inference_camera_name(::yolov8_msgs::msg::Yolov8Inference & msg)
  : msg_(msg)
  {}
  ::yolov8_msgs::msg::Yolov8Inference camera_name(::yolov8_msgs::msg::Yolov8Inference::_camera_name_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Yolov8Inference_camera_name yolov8_inference(::yolov8_msgs::msg::Yolov8Inference::_yolov8_inference_type arg)
  {
    msg_.yolov8_inference = std::move(arg);
    return Init_Yolov8Inference_camera_name(msg_);
  }
