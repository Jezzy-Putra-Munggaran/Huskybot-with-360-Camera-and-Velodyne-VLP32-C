...
static rosidl_typesupport_introspection_c__MessageMember yolov8_msgs__msg__Yolov8Inference__rosidl_typesupport_introspection_c__Yolov8Inference_message_member_array[3] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs__msg__Yolov8Inference, camera_name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
