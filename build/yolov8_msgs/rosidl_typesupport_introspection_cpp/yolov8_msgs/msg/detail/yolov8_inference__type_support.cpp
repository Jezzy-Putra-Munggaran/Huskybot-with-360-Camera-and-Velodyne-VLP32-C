...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Yolov8Inference_message_member_array[3] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs::msg::Yolov8Inference, camera_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
