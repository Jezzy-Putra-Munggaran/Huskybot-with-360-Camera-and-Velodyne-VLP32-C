...
bool yolov8_msgs__msg__yolov8_inference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._yolov8_inference.Yolov8Inference", full_classname_dest, 49) == 0);
  }
  yolov8_msgs__msg__Yolov8Inference * ros_message = _ros_message;
  {  // header
  ...
  {  // yolov8_inference
    ...
    if (!yolov8_msgs__msg__InferenceResult__Sequence__init(&(ros_message->yolov8_inference), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create yolov8_msgs__msg__InferenceResult__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    yolov8_msgs__msg__InferenceResult * dest = ros_message->yolov8_inference.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!yolov8_msgs__msg__inference_result__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * yolov8_msgs__msg__yolov8_inference__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._yolov8_inference");
  ...
  {  // yolov8_inference
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = yolov8_msgs__msg__inference_result__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
