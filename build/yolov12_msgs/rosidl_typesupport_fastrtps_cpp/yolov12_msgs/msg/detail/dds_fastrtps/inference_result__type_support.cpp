...
#include "yolov12_msgs/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov12_msgs::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov12_msgs::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov12_msgs::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &yolov12_msgs::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
